# CompletarParadaFalloFn

Registra un fallo real de retiro para una parada Gammavet exacta y valida que Tenant API afecte el route_stop_id solicitado
...
- The function name matches "CompletarParadaFalloFn"
...
- AWS CloudWatch Logs: `/aws/lambda/CompletarParadaFalloFn`
- Chask dashboard: Organization → Functions → CompletarParadaFalloFn
